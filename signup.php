        ...
        <div class="single-blog-area ptb100 fix">
            <div class="container">
                <div class="row outer-form">
                    <div class="col-md-12 col-sm-12 col-lg-4 form-inner">
                        <div class="single-blog-body">
                            <div class="Leave-your-thought ">
                                <h3 class="section-title uppercase">User Signup</h3>
                                <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-6 col-xs-12 lyt-left">
                                            <div class="input-box leave-ib">
                                                ...
                                                <input type="text" placeholder="Username" class="info" name="username"
                                                    id="username" required="true" onBlur="checkusernameAvailability()">
                                                <span id="username-availabilty-status" style="font-size:14px;"></span>
                                                <input type="email" placeholder="Email Id" class="info" name="email"
                                                    required="true">
                                                ...
                                                <input type="password" name="pass"
                                                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" placeholder="Password"
                                                    title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters"
                                                    class="info" required />
                                                <span style="font-size:11px; color:red">Password atleast one number and
                                                    one uppercase and lowercase letter, and at least 6 or more
                                                    characters</span>
                                            </div>
                                        </div>
